...
import com.example.no0ne.appointmentsystem.adapter.TeacherPagerAdapter;
...
//    private Boolean mIsFragment = false;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTeacherEditInfoButton = findViewById(R.id.button_teacher_edit_info);

        mViewPager = findViewById(R.id.teacher_view_pager);
        mTabLayout = findViewById(R.id.teacher_tab_layout);
        mDrawerLayout = findViewById(R.id.teacher_drawer_layout);
